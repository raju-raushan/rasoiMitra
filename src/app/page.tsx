          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-muted-foreground">
                Our mission is to make home cooking easier and more
                sustainable. By helping you use the ingredients you already
                have, we aim to reduce food waste and inspire creativity in the
                kitchen, one delicious meal at a time.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="max-w-2xl mx-auto text-muted-foreground mt-2">
                Discover the simple steps to transform your fridge's contents
                into amazing meals.
              </p>
            </div>
            <div className="grid md:grid-cols-3 gap-8">
              <Card className="p-8 text-center">
                <CardContent className="p-0 flex flex-col items-center gap-4">
                  ...
                  <p className="text-muted-foreground">
                    Upload a photo of your fridge, and our AI will automatically
                    detect all your ingredients in seconds.
                  </p>
                </CardContent>
              </Card>
              <Card className="p-8 text-center">
                <CardContent className="p-0 flex flex-col items-center gap-4">
                  ...
                  <p className="text-muted-foreground">
                    Receive personalized recipe recommendations based on your
              ...
              <Card className="p-8 text-center">
                <CardContent className="p-0 flex flex-col items-center gap-4">
                  ...
                  <p className="text-muted-foreground">
                    Manually add or remove items to keep a real-time inventory
      ...
      <footer className="bg-background border-t">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-4 border-t">
          <p className="text-sm text-muted-foreground text-center">
            © 2024 SmartFridge. All rights reserved.
          </p>
        </div>
      </footer>
    </div>
